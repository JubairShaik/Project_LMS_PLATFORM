    ...
    <div className="flex flex-col gap-6">
      <section className="flex flex-col items-center justify-center h-full container gap-6 pt-10 md:pt-24 lg:pt-36">
        ...
        Learn the Skills You Need, for the{" "}
          ...
          <span className="text-primary">Future</span> You Want
        </h1>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link className={cn(buttonVariants({ variant: "outline", size: "lg" }), "duration-300 transition-all")} href="https://github.com/JubairShaik">
            Github
          </Link>
        </div>
      </section>
